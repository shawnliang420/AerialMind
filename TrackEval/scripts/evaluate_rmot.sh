...
--METRICS HOTA \
--SEQMAP_FILE /home/hy/code/vl_tracking/RMOT-UAV/RMOT-master/datasets/data_path/seqmap_rea.txt \
--SKIP_SPLIT_FOL True \
--GT_FOLDER /home2/data/UAV-RMOT/rmot_train/training/image_02 \
--TRACKERS_FOLDER /home/hy/code/vl_tracking/RMOT-UAV/RMOT-master/exps/default/results_epoch80 \
--GT_LOC_FORMAT {gt_folder}{video_id}/{expression_id}/gt.txt \
--TRACKERS_TO_EVAL /home/hy/code/vl_tracking/RMOT-UAV/RMOT-master/exps/default/results_epoch80 \
--USE_PARALLEL True \
