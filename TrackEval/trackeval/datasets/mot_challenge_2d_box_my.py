...
class MotChallenge2DBox_my(_BaseDataset):
        ...
        for tracker in self.tracker_list:
            if self.data_is_zipped:
                ...
                for seq in self.seq_list:
                    ...
                    curr_file = os.path.join(self.tracker_fol, seq.split('+')[0], seq.split('+')[1], 'predict.txt')
                    if not os.path.isfile(curr_file):
                        # f = open(curr_file, 'a')
                        # f.close()
                        print('Tracker file not found: ' + curr_file)
            ...
            with open(seqmap_file) as fp:
                ...
                for i, row in enumerate(reader):
                    ...
                    if 'MOT' in seq:
                        ...
                        img_path = os.path.join('/home/data/UAV-RMOT/rmot_train/training/image_02', seq)
    ...
    def _load_raw_file(self, tracker, seq, is_gt):
        ...
        if self.data_is_zipped:
            ...
            if is_gt:
                ...
                file = os.path.join(self.tracker_fol, seq.split('+')[0], seq.split('+')[1], 'predict.txt')
